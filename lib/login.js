...
module.exports.authenticateDevice = function(appToken, appSecret, callback) {
	...
	oauthAssembly.baseParameter(date, nonce, null, null, appToken, [], function(baseParameterData) {
		oauthAssembly.requestUrl(url, [], function(url, encodedUrl){
			oauthAssembly.signatureBaseString("POST", encodedUrl, baseParameterData, function(signatureBaseString){
				oauthAssembly.signature(signatureBaseString, null, appSecret, function(signature){
					oauthAssembly.authorizationHeader(date, nonce, signature, null, null, appToken, function(authHeader){
						request.post(url, {
							headers:{
